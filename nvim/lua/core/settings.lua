...
-- Format on save
cmd [[autocmd BufWritePre * :lua vim.lsp.buf.formatting()]]
...
cmd [[
  autocmd FileType xml,html,xhtml,css,scss,javascript,typescript,typescriptreact,lua,yaml,dart setlocal shiftwidth=2 tabstop=2
]]
cmd [[
